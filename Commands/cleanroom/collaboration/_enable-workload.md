# [Command] _cleanroom collaboration enable-workload_
...
- Enable Workload
    ```bash
        cleanroom collaboration enable-workload --resource-group testrg --collaboration-name ContosoCollaboration --workload-type analytics
    ```
