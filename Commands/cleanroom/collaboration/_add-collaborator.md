# [Command] _cleanroom collaboration add-collaborator_
...
- Add Collaborator
    ```bash
        cleanroom collaboration add-collaborator --resource-group testrg --collaboration-name ContosoCollaboration --email alice@example.com
    ```
