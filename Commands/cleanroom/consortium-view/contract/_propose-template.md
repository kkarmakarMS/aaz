# [Command] _cleanroom consortium-view contract propose-template_
...
- Generate template for a contract
    ```bash
        cleanroom consortium-view contract propose-template --resource-group testrg --consortium-view-name ContosoConsortiumView --contract-name ContosoContract
    ```
